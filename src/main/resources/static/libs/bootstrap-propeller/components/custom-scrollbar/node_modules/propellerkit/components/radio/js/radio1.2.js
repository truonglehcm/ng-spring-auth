var pmdRadio = function ($) {
    ...
    var Selector = {
        PARENT_SELECTOR: '',
        PMD_RADIO_INPUT: 'input:radio:not(.pm-ini)',
        PMD_RADIO_RIPPLE: '.pmd-radio-ripple-effect',
        INK: '.ink'
    };
    ...
    var pmdRadio = function () {
        ...
        function pmdRadio() {
            var finalSelector = pmdRadio.prototype.attachParentSelector(Selector.PARENT_SELECTOR, Selector.PMD_RADIO_INPUT);
            $(finalSelector).after(Template.RADIO_LABEL);
    ...
    $(document).on(Event.MOUSE_DOWN, Selector.PMD_RADIO_RIPPLE, onMouseDown);
